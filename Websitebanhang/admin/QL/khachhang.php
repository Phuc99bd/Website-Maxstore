  ...
  <style type="text/css">
    ...
    <div class="container">
        ...
        <div class="search-box" id="load-box">  
          <form class="search-form" action="index.php?QL=sanpham&HD=search" method="post"> <input class="form-control timkiem" placeholder="Tìm kiếm Tên khách hàng" type="text" name="search" id="tim-kiem"> 
         ...
         <script type="text/javascript">
            $('.timkiem').keyup(function(){
              var txt = $('.timkiem').val(); 
              $.post('ajax/searchkhachhang.php',{data: txt },function(data){
                $('.danhsach2').html(data);
              });
            })
        </script>   
    <?php
      ...
      $sql="select * FROM khachhang order by id DESC LIMIT $start, $limit ";
